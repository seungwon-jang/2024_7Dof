...
#include "apf_interfaces/srv/detail/rrts_points__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message.obstacle_points;
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: obstacle_points
  {
    ...
    size_t item_size = sizeof(ros_message.obstacle_points[0]);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = apf_interfaces::srv::RRTSPoints_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const apf_interfaces::srv::RRTSPoints_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<apf_interfaces::srv::RRTSPoints_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RRTSPoints_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const apf_interfaces::srv::RRTSPoints_Request *>(
...
static size_t _RRTSPoints_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RRTSPoints_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RRTSPoints_Request__callbacks = {
  "apf_interfaces::srv",
  "RRTSPoints_Request",
...
static rosidl_message_type_support_t _RRTSPoints_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RRTSPoints_Request__callbacks,
...
{
  return &apf_interfaces::srv::typesupport_fastrtps_cpp::_RRTSPoints_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  // Member: result_points
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.result_points[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: point_count
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = apf_interfaces::srv::RRTSPoints_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const apf_interfaces::srv::RRTSPoints_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<apf_interfaces::srv::RRTSPoints_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RRTSPoints_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const apf_interfaces::srv::RRTSPoints_Response *>(
...
static size_t _RRTSPoints_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RRTSPoints_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RRTSPoints_Response__callbacks = {
  "apf_interfaces::srv",
  "RRTSPoints_Response",
...
static rosidl_message_type_support_t _RRTSPoints_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RRTSPoints_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &apf_interfaces::srv::typesupport_fastrtps_cpp::_RRTSPoints_Response__handle;
}
...
static service_type_support_callbacks_t _RRTSPoints__callbacks = {
  "apf_interfaces::srv",
  "RRTSPoints",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, apf_interfaces, srv, RRTSPoints_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, apf_interfaces, srv, RRTSPoints_Response)(),
...
static rosidl_service_type_support_t _RRTSPoints__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RRTSPoints__callbacks,
...
{
  return &apf_interfaces::srv::typesupport_fastrtps_cpp::_RRTSPoints__handle;
}
