...
static const _Distance_type_support_symbol_names_t _Distance_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, apf_interfaces, msg, Distance)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, apf_interfaces, msg, Distance)),
  }
};
...
{
  return &::apf_interfaces::msg::rosidl_typesupport_cpp::Distance_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, apf_interfaces, msg, Distance)() {
  return get_message_type_support_handle<apf_interfaces::msg::Distance>();
}
