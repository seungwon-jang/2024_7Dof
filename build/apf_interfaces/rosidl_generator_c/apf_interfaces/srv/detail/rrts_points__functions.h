...
#ifndef APF_INTERFACES__SRV__DETAIL__RRTS_POINTS__FUNCTIONS_H_
#define APF_INTERFACES__SRV__DETAIL__RRTS_POINTS__FUNCTIONS_H_
...
/// Initialize srv/RRTSPoints message.
/**
...
/// Finalize srv/RRTSPoints message.
/**
...
/// Create srv/RRTSPoints message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * apf_interfaces__srv__RRTSPoints_Request__init().
...
/// Destroy srv/RRTSPoints message.
/**
 * It calls
 * apf_interfaces__srv__RRTSPoints_Request__fini()
...
/// Check for srv/RRTSPoints message equality.
/**
...
/// Initialize array of srv/RRTSPoints messages.
/**
...
/// Finalize array of srv/RRTSPoints messages.
/**
 * It calls
 * apf_interfaces__srv__RRTSPoints_Request__fini()
...
/// Create array of srv/RRTSPoints messages.
/**
 * It allocates the memory for the array and calls
 * apf_interfaces__srv__RRTSPoints_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/RRTSPoints messages.
/**
 * It calls
 * apf_interfaces__srv__RRTSPoints_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/RRTSPoints message array equality.
/**
...
/// Copy an array of srv/RRTSPoints messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * apf_interfaces__srv__RRTSPoints_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_apf_interfaces
...
/**
 * It calls
 * apf_interfaces__srv__RRTSPoints_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_apf_interfaces
...
/**
 * It allocates the memory for the array and calls
 * apf_interfaces__srv__RRTSPoints_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_apf_interfaces
...
/**
 * It calls
 * apf_interfaces__srv__RRTSPoints_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // APF_INTERFACES__SRV__DETAIL__RRTS_POINTS__FUNCTIONS_H_
